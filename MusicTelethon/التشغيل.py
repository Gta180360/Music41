    ...
    if replied:
        if replied.audio or replied.voice:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    photo="https://telegra.ph/file/6d92e1766297ae09eaf8f.jpg",
                    caption=f"""
...
async def stop(client, m: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            clear_queue(chat_id)
            await m.reply("**✅ تم ايقاف التشغيل بنجاح 👈 تم التطوير من قبل عبدالله(ميططرون ) ( @a150a ) 👈 تم التطوير من قبل عبدالله(ميططرون ) ( @a150a ) **")
        except Exception as e:
